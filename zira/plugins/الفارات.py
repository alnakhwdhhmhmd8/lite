...
ZelzalVP_cmd = (
    "𓆩 [𝙕𝞝𝘿 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/CU_FG) 𓆪\n\n"
    ...
    "\n𓆩 [𝙕𝞝𝘿 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/zzzvrr) 𓆪"
)
...
async def variable(event):
    ...
    viran = "Asia/Tehran"
    heroku_var = app.config()
    zed = await edit_or_reply(event, "**⎉╎جـاري أعـداد المنطقـه الزمنيـه لـ زدجـاك 🌐...**")
    # All Rights Reserved for "Zed-Thon" "زلـزال الهيبـه"
