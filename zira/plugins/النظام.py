...
async def psu(event):
    ...
    softw = "** 𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝙕𝞝𝘿𝙏𝙕𝞝𝘿 𝑺𝒀𝑺𝑻𝑬𝑴 𝑰𝑵𝑭𝑶 𓆪 **\n"
...
async def _(event):
    ...
    zzz1 = await edit_or_reply(event, f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**")
    await asyncio.sleep(1)
    zzz2 = await zzz1.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz3 = await zzz2.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz4 = await zzz3.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz5 = await zzz4.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟺𝟶 ▬▬▬▬▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz6 = await zzz5.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟻𝟶 ▬▬▬▬▬▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz7 = await zzz6.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟼𝟶 ▬▬▬▬▬▬▭▭▭▭")
    await asyncio.sleep(1)
    zzz8 = await zzz7.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟽𝟶 ▬▬▬▬▬▬▬▭▭▭")
    await asyncio.sleep(1)
    zzz9 = await zzz8.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟾𝟶 ▬▬▬▬▬▬▬▬▭▭") 
    await asyncio.sleep(1)
    zzzz10 = await zzz9.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟿𝟶 ▬▬▬▬▬▬▬▬▬▭") 
    await asyncio.sleep(1)
    zzzz11 = await zzzz10.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت زدجـاك . . .🌐**\n\n%𝟷𝟶𝟶 ▬▬▬▬▬▬▬▬▬▬💯") 
    sandy = await edit_or_reply(
        zzzz11,
        f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 🝢 **إعــادة التشغيــل**\n"
        f"**•─────────────────•**\n\n"
        f"**•⎆┊اهـلا عـزيـزي** - {mention}\n"
        f"**•⎆┊يتـم الان اعـادة تشغيـل بـوت زدجـاك**\n"
...
async def zeddd(event): # Code By t.mewvvwv3
    uname = platform.uname()
    zedt = "**- تاريخ تنصيبـك لـ بـوت زدثـــون - 𓆩𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿𓆪**\n\n"
    if gvarstatus("z_date") is not None: # Code By t.mewvvwv3
        zzd = gvarstatus("z_date")
        zzt = gvarstatus("z_time")
    else: # Code By t.mewvvwv3
        boot_time_timestamp = psutil.boot_time()
        bt = datetime.fromtimestamp(boot_time_timestamp)
